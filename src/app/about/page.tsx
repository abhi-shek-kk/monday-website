  ...
  return (
    <main className="w-[96%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        <div className="lg:col-span-7 bg-white dark:bg-[#1C1917] p-8 sm:p-10 rounded-3xl border border-[#EFEAE3] dark:border-[#282420] shadow-xs space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="relative w-full h-64 rounded-2xl overflow-hidden bg-[#FBF9F7] dark:bg-[#231F1C] border border-[#EFEAE3] dark:border-[#38322D]">
              <Image
          ...
          <div className="pt-4 flex items-center gap-2 text-xs font-bold text-[#1C1917] dark:text-white border-t border-[#EFEAE3] dark:border-[#282420]">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          <div className="bg-[#1C1917] dark:bg-[#1C1917] text-white p-8 rounded-3xl border border-[#231F1C] dark:border-[#282420] space-y-6 flex-1 flex flex-col justify-between">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
              <span className="text-xs text-[#A89F91] font-semibold uppercase tracking-wider block">
                Inaugural Cohort
              </span>
          ...
          <div className="relative w-full h-56 rounded-3xl overflow-hidden bg-[#FBF9F7] dark:bg-[#231F1C] border border-[#EFEAE3] dark:border-[#38322D] shadow-xs">
            <Image
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-8 rounded-3xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] shadow-xs space-y-4">
          <div className="w-12 h-12 rounded-2xl bg-[#1C1917] dark:bg-[#FDB27C] text-[#FDB27C] dark:text-[#1C1917] flex items-center justify-center">
            <Compass className="w-6 h-6" />
          </div>
          <h3 className="text-2xl font-bold font-heading text-[#1C1917] dark:text-white">Department Vision</h3>
        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] shadow-xs space-y-4">
          ...
          <h3 className="text-2xl font-bold font-heading text-[#1C1917] dark:text-white">Department Mission</h3>
          <ul className="space-y-2.5 text-sm text-[#756860] dark:text-[#A89F91]">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-2xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] space-y-3">
            <span className="px-2.5 py-1 rounded-md bg-[#FDB27C]/20 text-[#1C1917] dark:text-[#FDB27C] text-xs font-bold inline-block">
              NSS WING
            </span>
            <h3 className="text-lg font-bold text-[#1C1917] dark:text-white">National Service Scheme</h3>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] space-y-3">
            <span className="px-2.5 py-1 rounded-md bg-[#EFEAE3] dark:bg-[#282420] text-[#1C1917] dark:text-white text-xs font-bold inline-block">
              TECH TEAM
            </span>
            <h3 className="text-lg font-bold text-[#1C1917] dark:text-white">Department Tech Team</h3>
            <p className="text-xs text-[#756860] dark:text-[#A89F91] leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#1C1917] dark:text-white">Sports & Athletics</h3>
            <p className="text-xs text-[#756860] dark:text-[#A89F91] leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#1C1917] border border-[#EFEAE3] dark:border-[#282420] space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#1C1917] dark:text-white">National Cadet Corps</h3>
            <p className="text-xs text-[#756860] dark:text-[#A89F91] leading-relaxed">
      ...
      <section className="bg-[#FBF9F7] dark:bg-[#1C1917] p-8 sm:p-12 rounded-3xl border border-[#EFEAE3] dark:border-[#282420] text-center space-y-4">
        ...
        <div className="pt-2">
          <Link
            href="/academics"
            className="inline-flex items-center gap-2 py-3 px-6 rounded-2xl bg-[#1C1917] dark:bg-[#FDB27C] text-white dark:text-[#1C1917] text-sm font-medium hover:bg-[#231F1C] dark:hover:bg-[#fca562] transition-all shadow-sm font-bold"
          >
            View Academics & Courses <ArrowRight className="w-4 h-4 text-[#FDB27C] dark:text-[#1C1917]" />
          </Link>
        </div>
      </section>
    </main>
